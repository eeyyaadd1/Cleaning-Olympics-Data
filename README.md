...
1. Encoding & Data Loading: Resolved character encoding issues (UTF-8/Latin-1) to ensure athlete names like Jean-François Blanchy are rendered correctly. Added low_memory=False to handle mixed-type columns efficiently.
